...
import { ShieldCheck, Clock, Users, ChevronRight, Award, CheckCircle, Wrench, X } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            id="estimate"
            className="hidden lg:block animate-[fadeIn_0.5s_ease-out]"
          >
            <EstimateForm />
          </motion.div>
        </div>
      ...
      {isModalOpen && (
        ...
        >
          <div 
            className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-y-auto max-h-[90vh] relative"
